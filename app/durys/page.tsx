...
export const metadata: Metadata = {
  title: "Durys | A+ Langai",
  description:
    "Aukščiausios kokybės lauko ir vidaus durys jūsų namams. Platus dizainų pasirinkimas, profesionalus montavimas.",
}
      ...
      <main className="flex-1">
        ...
        <section className="relative py-12 md:py-24 bg-sky-700">
          <div className="container px-4 md:px-6 text-center">
            <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-white mb-4">Durys</h1>
            <p className="max-w-[800px] mx-auto text-white/90 md:text-xl">
              Aukščiausios kokybės lauko ir vidaus durys jūsų namams
            </p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-24">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tighter mb-2">Durų tipai</h2>
              <p className="text-muted-foreground md:text-lg">Pasirinkite duris pagal savo poreikius ir namo stilių</p>
            </div>

            <div className="grid gap-8 md:grid-cols-2">
              <div className="group relative overflow-hidden rounded-lg border">
                <div className="relative h-[300px] sm:h-[400px] bg-gray-200 flex items-center justify-center">
                  <div className="text-gray-400">Lauko durys</div>
                </div>
                <div className="p-5">
                  <h3 className="text-xl font-bold">Lauko durys</h3>
                  <p className="mt-2 text-muted-foreground">
                    Patikimos ir saugios lauko durys, užtikrinančios puikią šilumos izoliaciją ir apsaugą nuo
                    įsilaužimų.
                  </p>
                  <Button className="mt-4 bg-sky-600 hover:bg-sky-700">Sužinoti daugiau</Button>
                </div>
              </div>

              <div className="group relative overflow-hidden rounded-lg border">
                <div className="relative h-[300px] sm:h-[400px] bg-gray-200 flex items-center justify-center">
                  <div className="text-gray-400">Vidaus durys</div>
                </div>
                <div className="p-5">
                  <h3 className="text-xl font-bold">Vidaus durys</h3>
                  <p className="mt-2 text-muted-foreground">
                    Stilingos ir funkcionalios vidaus durys, papildančios jūsų namų interjerą.
                  </p>
                  <Button className="mt-4 bg-sky-600 hover:bg-sky-700">Sužinoti daugiau</Button>
                </div>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="relative h-[400px] rounded-lg overflow-hidden bg-gray-200 flex items-center justify-center">
                <div className="text-gray-400">Durų savybės</div>
              </div>
              <div>
                <h2 className="text-3xl font-bold tracking-tighter mb-4">Durų savybės</h2>
                <p className="text-muted-foreground mb-6">
                  Mūsų durys pasižymi aukščiausia kokybe ir funkcionalumu, užtikrinančiu ilgaamžiškumą ir patikimumą.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-sky-600 mr-2 mt-0.5" />
                    <div>
                      <h3 className="font-medium">Šilumos izoliacija</h3>
                      <p className="text-muted-foreground">
                        Puiki šilumos izoliacija, padedanti taupyti šildymo išlaidas.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-sky-600 mr-2 mt-0.5" />
                    <div>
                      <h3 className="font-medium">Garso izoliacija</h3>
                      <p className="text-muted-foreground">
                        Efektyvi garso izoliacija, užtikrinanti ramybę jūsų namuose.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-sky-600 mr-2 mt-0.5" />
                    <div>
                      <h3 className="font-medium">Apsauga nuo įsilaužimų</h3>
                      <p className="text-muted-foreground">
                        Patikima apsauga nuo įsilaužimų, užtikrinanti jūsų namų saugumą.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-sky-600 mr-2 mt-0.5" />
                    <div>
                      <h3 className="font-medium">Ilgaamžiškumas</h3>
                      <p className="text-muted-foreground">
                        Ilgaamžės durys, atsparios aplinkos poveikiui ir mechaniniams pažeidimams.
                      </p>
                    </div>
                  </div>
                </div>
